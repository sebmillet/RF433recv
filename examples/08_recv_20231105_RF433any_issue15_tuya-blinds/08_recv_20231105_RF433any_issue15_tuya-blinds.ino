// 08_recv_20231105_RF433any_issue15_tuya-blinds.ino

// Example sketch that comes along with RF433recv library.
// Implements what is needed to decode an arbitrary signal.

/*
  Copyright 2023 Sébastien Millet
...
void setup() {
    ...
    rf.register_Receiver(
        ...
        400,          // lo_short
        600,          // lo_long
        1000,         // hi_short (0 => take lo_short)
        400,          // hi_long  (0 => take lo_long)
        200,          // lo_last
        3000,         // sep
        72,           // nb_bits
        callback,
